...
log_path = 'X:/GXB/SNS/train_log/train_kernel_2/'
...
if __name__ == '__main__':
    ...
    for epoch in range(1 , train_epoch + 1):
        ...
        while sr.data_flag:
            ...
            loss = unet_model.train_on_batch(imgs , masks)
            ...
            if batch_i % log_step == 0:
                ...
                # 在测试集上进行模型的评估
                test_imgs , test_masks = sr.generate_test_data()
                v_loss = unet_model.evaluate(test_imgs , test_masks , verbose = 0)
